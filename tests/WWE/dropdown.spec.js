...
//     //or 
//     await page.locator('#country').selectOption({label : "Egypt"})  //text and lebel bith are same 
//     await page.waitForTimeout(3000)
...
//       await page.locator('#country').selectOption({index : 4}) //in the cypress only we have give (4) inplaywright ({index:4})
