...
// //multiple chckboxes created as a array then for of loop implimented
// //===================================================================================
...
// // more than 100 checkboxes matching single element implimentingand for of loop implimented
// //======================================================================================================
...
test("radiobutton practice with guru99",async({page})=>{
...
const isChecked = await page.locator('input[value="Option 3"]').isChecked()
